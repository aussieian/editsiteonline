...
<form id='editdomain' method='POST'>
	...
	<div id="editdomainform">
		...
		<div style="clear: both; padding-top: 15px; text-align: left;">- OR - Edit HTML <span style="font-size: 10pt;"><?php if (get_page_backup($domain, $page) != "") { ?><a style="color: #00A0B0;" href="http://<?php print($domain.$page."/backup");?>">previous version</a></span><? } ?><br><textarea name='content' class="editcontent"><?php print($content);?></textarea></div>
