...
<form id='remove_page' method='POST'>
	<div id="remove_page_form">
		...
		<div style="padding-left: 50px; clear: both; padding-top: 15px;"><input type='submit' style="font-size: 12pt; color: #fff;" value='remove page &raquo;' class="button orange"></div>
	</div>
</form>
</div>
</body>
